...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-30 bg-white border-t border-gray-200 dark:bg-gray-900 dark:border-gray-700 md:hidden safe-area-pb overflow-x-auto">
